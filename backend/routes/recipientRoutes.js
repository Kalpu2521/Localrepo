...
import { createRecipient, getRecipients, getRecipientById, updateRecipient, deleteRecipient, getMyRecipientProfile } from "../controllers/recipientController.js";

const router = Router();

router.get("/", getRecipients);
router.get("/me", requireAuth, getMyRecipientProfile);
