    ...
    <header className="bg-black/60 backdrop-blur text-white fixed top-0 left-0 right-0 z-50">
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {user ? (
            <>
              <Link to="/dashboard" className="px-4 py-2 rounded border border-red-500 text-red-400 hover:bg-red-500 hover:text-white transition">
                Dashboard
              </Link>
              <button 
            ...
            <>
              ...
              <Link to="/signup" className="px-4 py-2 rounded bg-red-600 hover:bg-red-500 transition">Sign Up</Link>
